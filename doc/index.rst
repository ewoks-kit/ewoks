...
**Ewoks is an ecosystem of Python packages designed to execute computational graphs**, also known as :term:`workflows <workflow>`.
...
:term:`Ewoks` has been developed by the `Software group <http://www.esrf.eu/Instrumentation/software>`_
...
.. admonition:: Quick Start
   ...
   Execute the demo :term:`workflow`
